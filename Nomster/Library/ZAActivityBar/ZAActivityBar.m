...
/*
            ...
            posAnimation            = [CABasicAnimation animationWithKeyPath:@"position.y"];
            posAnimation.fromValue  = bounceOrigin;
            posAnimation.toValue    = bounceFinalValue;
            posAnimation.duration   = 0.5f;
            posAnimation.removedOnCompletion = YES;
            posAnimation.fillMode   = kCAFillModeForwards;
            
            [self.barView.layer addAnimation: posAnimation forKey:@"showAnimation"];
 ...
 */
            CGPoint position = self.barView.layer.position;
            position.y = [self getBarYPosition];
            [self.barView.layer setPosition:position];
        }
